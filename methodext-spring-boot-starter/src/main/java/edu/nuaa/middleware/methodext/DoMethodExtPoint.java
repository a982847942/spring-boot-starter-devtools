package edu.nuaa.middleware.methodext;

import com.alibaba.fastjson.JSON;
import edu.nuaa.middleware.methodext.annotation.DoMethodExt;
...
public class DoMethodExtPoint {
    ...
    @Pointcut("@annotation(edu.nuaa.middleware.methodext.annotation.DoMethodExt)")
